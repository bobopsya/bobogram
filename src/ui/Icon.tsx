...
const ICONS = {
  ...
  checks: <path d="M17 6L6.5 16.5 2 12M22.5 8l-8.5 8.5-1.5-1.5" />,
  clock: (
    <>
  ...
  pin: (
    <path d="M12 17v5M9 10.76V6a1 1 0 00-1-1 2 2 0 010-4h8a2 2 0 010 4 1 1 0 00-1 1v4.76a2 2 0 001.11 1.79l1.78.9A2 2 0 0119 15.24V16a1 1 0 01-1 1H6a1 1 0 01-1-1v-.76a2 2 0 011.11-1.79l1.78-.9A2 2 0 009 10.76z" />
  ),
  bell: <path d="M6 8a6 6 0 0112 0c0 7 3 9 3 9H3s3-2 3-9M10.3 21a1.94 1.94 0 003.4 0" />,
  bellOff: (
    <path d="M8.7 3A6 6 0 0118 8a21.3 21.3 0 00.6 5M17 17H3s3-2 3-9a4.67 4.67 0 01.3-1.7M10.3 21a1.94 1.94 0 003.4 0M2 2l20 20" />
  ),
  edit: <path d="M17 3a2.85 2.83 0 114 4L7.5 20.5 2 22l1.5-5.5z" />,
  trash: <path d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2" />,
  reply: <path d="M9 17l-5-5 5-5M20 18v-2a4 4 0 00-4-4H4" />,
  forward: <path d="M15 17l5-5-5-5M4 18v-2a4 4 0 014-4h12" />,
  copy: (
    <>
  ...
  phone: <path d={phone} />,
  hangup: <path d={phone} transform="rotate(135 12 12)" />,
  video: (
    <>
  ...
  screen: (
    <>
      ...
      <path d="M8 21h8M12 17v4M12 13V7M9 10l3-3 3 3" />
    </>
  ),
  speaker: (
    <>
  ...
  flip: <path d="M23 4v6h-6M1 20v-6h6M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15" />,
  qr: <path d="M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM14 14h3v3h-3zM18 18h3v3h-3zM14 20h1M20 14h1" />,
  link: (
  ...
  volume: <path d="M11 5L6 9H2v6h4l5 4V5zM19.07 4.93a10 10 0 010 14.14M15.54 8.46a5 5 0 010 7.07" />,
  arrowIn: <path d="M17 7L7 17M16 17H7V8" />,
